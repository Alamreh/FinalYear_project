			...
			<div class="container">
				<div class="signup-content">
					...
					<div class="signup-image">
						<figure>
							<img src="images/e-learning_reg.jpeg" alt="sing up image">
						</figure>
 ...
 -->
	...
	<script>
	  ...
	  if(status=="invalidName")
		  swal("Invalid","Invalid Name","error");
	  if(status=="invalidNumber")
		  swal("Invalid","Invalid Number","error");
	  
	  if(status=="passnotMatch")
		  swal("Incorrect Password","Password Not Match","error")
	</script>
